...
{
{text = '𝑀𝐸𝐺𝐺𝐴 𝑆𝑂𝑈𝑅𝑆𝐸', url = "https://t.me/MicaS"}
},
}
local msgg = msg_id/2097152/0.5
...
if text == (Redis:get(TheMica.."Mica:Name:Bot") or "لاريكا") then
local NamesBot = (Redis:get(TheMica.."Mica:Name:Bot") or "لاريكا")
local NameBots = {
"ها "..NamesBot.. " شتريد؟",
"أჂ̤ أჂ̤ هياتني اني",
"موجود بس لتصيح",
...
local CmdStart = '*\n⌔︰أهلآ بك في بوت '..(Redis:get(TheMica.."Mica:Name:Bot") or "لاريكا")..
